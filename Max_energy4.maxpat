...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 182.0, 490.0, 100.0, 33.0 ],
					"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 953.0, 51.0, 73.0, 73.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 938.0, 19.0, 103.0, 20.0 ],
									"style" : "",
									"text" : "COUNTDOWN"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 724.0, 51.0, 73.0, 73.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 709.0, 19.0, 103.0, 20.0 ],
									"style" : "",
									"text" : "SET"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 492.0, 51.0, 73.0, 73.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 203.0, 51.0, 73.0, 73.0 ],
									"style" : ""
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.75, 399.0, 150.0, 33.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 295.75, 448.0, 114.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 298.5, 15.0, 63.0, 20.0 ],
									"presentation_rect" : [ 301.0, 15.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "position"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 218.0, 15.0, 38.0, 20.0 ],
									"style" : "",
									"text" : "hue"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 227.0, 613.0, 20.0, 140.0 ],
									"size" : 255.0,
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 259.0, 772.0, 106.0, 22.0 ],
									"style" : "",
									"text" : "s stepper1_speed"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 231.0, 43.0, 42.0, 140.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 294.5, 43.0, 42.0, 140.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 211.0, 219.0, 41.0, 32.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 94.0, 67.0, 22.0 ],
									"style" : "",
									"text" : "40, 9 3000"
								}
...
,
					"patching_rect" : [ 218.0, 565.0, 97.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 39.5, 549.0, 227.5, 549.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 139.5, 537.0, 305.5, 537.0 ],
					"source" : [ "obj-68", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 127.0, 536.0, 306.0, 536.0, 306.0, 549.0, 305.5, 549.0 ],
					"source" : [ "obj-70", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 305.25, 549.0, 305.5, 549.0 ],
					"source" : [ "obj-83", 0 ]
				}
